...
# -------------------------------
app = Flask(_name_,
             static_folder=os.path.join(os.path.dirname(os.path.abspath(_file_)), '..', 'static'),
             template_folder=os.path.join(os.path.dirname(os.path.abspath(_file_)), '..', 'templates'))

# Static files configuration for production
app.config['STATIC_FOLDER'] = os.path.join(os.path.dirname(os.path.abspath(_file_)), '..', 'static')
app.config['TEMPLATE_FOLDER'] = os.path.join(os.path.dirname(os.path.abspath(_file_)), '..', 'templates')

# Use instance directory for database consistency
instance_dir = os.path.join(os.path.dirname(os.path.abspath(_file_)), '..', 'instance')
